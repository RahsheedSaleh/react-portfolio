          ...
          <Row>
            <div className="col-lg-6 col-md-10 col-sm-11 col-11 mx-auto pt-3">
              ...
              <div className="card border-2 black shadow-lg shadow-dark mb-5">
                <img src="/to-do-list-app/main-view.png" onClick={() => setIstrue(true)} className="card-img-top"  alt="" />
                <div className="card-body">
                  ...
                  <a href="https://rahsheedsaleh.github.io/To-Do-List/" className="btn btn-primary me-2">View Demo</a>
                  <a href="https://github.com/RahsheedSaleh/To-Do-List.git" className="btn btn-primary">View Code</a>
                </div>
              </div>
    ...
    <div className="modal-dialog modal-lg modal-dialog-centered">
      <div className="modal-content">
        ...
        <div className="modal-header">
          <h5 className="modal-title">Smart To-Do List & Daily Task Manager</h5>
          ...
          <div id="carouselExample" className="carousel slide" data-bs-ride="carousel">
            ...
            <div className="carousel-inner">
              ...
              <div className="carousel-item active">
                <img src="/to-do-list-app/main-view.png" className="d-block w-100"/>
              </div>
  
              <div className="carousel-item">
                <img src="/to-do-list-app/edit-modal.png" className="d-block w-100"/>
              </div>
  
              <div className="carousel-item">
                <img src="/to-do-list-app/delete-modal.png" className="d-block w-100"/>
              </div>
