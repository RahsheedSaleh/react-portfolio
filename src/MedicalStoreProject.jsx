          ...
          <Row>
            <div className="col-lg-6 col-md-10 col-sm-11 col-11 mx-auto pt-3">
              ...
              <div className="card border-2 black shadow-lg shadow-dark mb-5">
                <img src="src/Project Images/View Modal 1.png" onClick={() => setIstrue(true)} className="card-img-top"  alt="" />
          ...
          <div id="carouselExample" className="carousel slide" data-bs-ride="carousel">
            ...
            <div className="carousel-inner">
              ...
              <div className="carousel-item active">
                <img src="src/Project Images/View modal 1.png" className="d-block w-100"/>
              </div>
  
              <div className="carousel-item">
                <img src="src/Project Images/Add Modal.png" className="d-block w-100"/>
              </div>
  
              <div className="carousel-item">
                <img src="src/Project Images/Veiw Detail.png" className="d-block w-100"/>
              </div>
  
              <div className="carousel-item">
                <img src="src/Project Images/Update Modal.png" className="d-block w-100"/>
              </div>
  
              <div clasNames="carousel-item">
                <img src="src/Project Images/Delete Modal.png" className="d-block w-100"/>
              </div>
